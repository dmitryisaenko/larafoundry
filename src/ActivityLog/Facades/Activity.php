 ...
 *
 * @method static \Illuminate\Database\Eloquent\Model log(string $description, string $logName = 'custom', array $properties = [], ?\Illuminate\Database\Eloquent\Model $subject = null, bool $isSuccessful = true, int $responseCode = 200, bool $geoSync = true, ?\Illuminate\Contracts\Auth\Authenticatable $causer = null)
